...
def render_login_wall():
    ...
    .headline-accent {
        ...
        line-height: 0.9;
        letter-spacing: -0.03em;
        background: linear-gradient(135deg, #f5a623 30%, #ff6b35 70%, #00d4ff 100%);
    ...
    .stat { flex: 1; text-align: center; padding: 14px 8px; border-right: 1px solid rgba(255,255,255,0.07); }
    .stat:last-child { border-right: none; }
    .stat-val { font-size: 24px; font-weight: 900; color: #f5a623; line-height: 1; }
    .stat-unit { font-size: 12px; color: #f5a623; }
    .stat-label { font-size: 8px; letter-spacing: 0.15em; text-transform: uppercase; color: rgba(255,255,255,0.3); margin-top: 3px; }
    ...
    .card-desc {
        font-size: 12px; color: rgba(255,255,255,0.35); margin-bottom: 24px; line-height: 1.6;
    }
    .sep {
    ...
    div[data-testid="stTextInput"] label {
        ...
        font-family: 'Inter', sans-serif !important; margin-bottom: 6px !important;
    }
    ...
    div[data-testid="stTextInput"] input::placeholder {
        color: rgba(255,255,255,0.22) !important; font-size: 14px !important;
    }
    ...
    <div class="page-wrap">
      ...
      <div class="stats-row">
        <div class="stat">
          <div class="stat-val">100<span class="stat-unit">ms</span></div>
          <div class="stat-label">Latency</div>
        </div>
        <div class="stat">
          <div class="stat-val">5<span class="stat-unit">+</span></div>
          <div class="stat-label">Exercises</div>
        </div>
        <div class="stat">
          <div class="stat-val">95<span class="stat-unit">%</span></div>
    ...
    # Streamlit form inside the card
    ...
    st.markdown("""
        <div class="foot-note">No password needed · Your progress is saved automatically</div>
      </div>
